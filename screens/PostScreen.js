...
export default class PostScreen extends Component {
    constructor(props) {
        ...
        this.state = {
            light_theme: true,
            likes: this.props.route.params.value.likes, //Numero de curtidas para o post
            is_liked: false //Estado para saber se o usuario curtiu o post
        };
    }
    ...
    likeAction = () => {
        //Funcao para cuidar da acao de curtidas no post
        if (this.state.is_liked) {
            //Se ja curtido, diminui o contador de curtidas no firebase
            firebase
                .database()
                .ref("posts")
            ...
            //Se nao curtido, aumenta o nome de curtidas no firebase
            firebase
                .database()
                .ref("posts")
                .child(this.props.route.params.key)
    ...
    render() {
        //Checa para posts validos de dados antes de renderizar
